...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 320.5, 330.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 40.0, 257.0, 299.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 173.0, 15.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 40.0, 91.0, 152.0, 22.0 ],
									"text" : "o.var"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "FullPacket" ],
									"patching_rect" : [ 40.0, 289.0, 107.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 480.75, 54.0, 90.0, 29.0 ],
									"text" : "user's full path to package"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 367.75, 142.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 480.75, 116.0, 90.0, 40.0 ],
									"text" : "package name.  change here if ever change"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 367.666666666666742, 114.0, 108.0, 22.0 ],
									"text" : "CNMAT-Pedagogy"
								}
...
, 							{
								"box" : 								{
									...
									"id" : "obj-13",
									"justification" : 4,
									"linecolor" : [ 0.101020082831383, 0.778426468372345, 0.921613454818726, 1.0 ],
									"maxclass" : "live.line",
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 619.5, 114.0, 102.5, 179.0 ],
									"saved_attribute_attributes" : 									{
										"linecolor" : 										{
											"expression" : ""
										}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 129.75, 152.0, 75.0, 51.0 ],
									"text" : "we add to the dict the user's full path to the package"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 203.833333333333371, 216.0, 38.0, 22.0 ],
									"text" : "zl.reg"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 401.75, 216.0, 229.0, 40.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 394.166666666666686, 197.0, 133.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 367.666666666666742, 166.5, 45.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 662.75, 34.0, 327.0, 40.0 ],
									"text" : "CNMAT-Pedagogy_config.json contains paths/names/appearance we will use in the system so it can be pretty dynamic.  But the path to this.json can't be auto-obtatined.  "
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 203.833333333333343, 250.0, 133.0, 22.0 ],
									"text" : "set names::package $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 121.916666666666686, 125.0, 126.0, 22.0 ],
									"text" : "set paths::package $1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 40.0, 88.0, 346.666666666666742, 22.0 ],
									"text" : "t b l b l b"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 662.75, 79.0, 327.0, 29.0 ],
									"text" : "So, if you ever change the name and location of CNMAT-Pedagogy_config.json, then this must change accordingly here"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 285.75, 357.0, 89.0, 22.0 ],
									"text" : "prepend import"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 285.75, 323.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 285.75, 288.0, 325.0, 22.0 ],
									"text" : "sprintf %spatchers/system/config/CNMAT-Pedagogy_config"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.458333333333371, 54.0, 391.75, 31.0 ],
									"text" : "\"Macintosh HD:/Users/jonathankulpa/Documents/Max 8/Packages/CNMAT-Pedagogy/\""
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 40.0, 505.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 40.0, 4.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "dictionary", "", "", "" ],
									"patching_rect" : [ 40.0, 462.0, 50.5, 22.0 ],
									"saved_object_attributes" : 									{
										"embed" : 0,
										"parameter_enable" : 0,
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 0 ],
									"midpoints" : [ 403.666666666666686, 456.0, 49.5, 456.0 ],
									"source" : [ "obj-38", 0 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "FullPacket" ],
									"patching_rect" : [ 24.0, 179.0, 71.0, 22.0 ],
									"text" : "o.route /title"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "FullPacket", "FullPacket" ],
									"patching_rect" : [ 24.0, 124.0, 385.0, 32.0 ],
									"text" : "/title = /names./package + /names./system_patch/1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "FullPacket" ],
									"patching_rect" : [ 24.0, 86.0, 151.0, 22.0 ],
									"text" : "o.var"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "dictionary" ],
									"patching_rect" : [ 156.0, 26.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 24.0, 218.0, 30.0, 30.0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 388.0, 426.0, 631.916666666666742, 38.0 ],
					"text" : "Hi, I'm the _system1.maxpat (the main patch in Extras) but I'm just named _overview (if that's what is also entered in CNMAT-Pedagogy_config.json."
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 131.0, 152.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "FullPacket" ],
									"patching_rect" : [ 50.0, 224.0, 115.0, 22.0 ],
									"text" : "o.route /fullpath/tree"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "FullPacket", "FullPacket" ],
									"patching_rect" : [ 50.0, 172.0, 349.0, 32.0 ],
									"text" : "/fullpath/tree = /paths./package + /paths./tree"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 255.0, 57.0, 22.0 ],
									"text" : "tosymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 324.0, 60.0, 22.0 ],
									"text" : "route null"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 50.0, 290.0, 111.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 183.5, 406.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 91.0, 406.0, 30.0, 30.0 ]
								}
...
, 			{
				"name" : "instantiate_system2s.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-Pedagogy/patchers/system/system_abstraction_dependencies",
				"patcherrelativepath" : "../patchers/system/system_abstraction_dependencies",
				"type" : "JSON",
				"implicit" : 1
