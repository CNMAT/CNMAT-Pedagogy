...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 248.0, 83.0, 20.0 ],
					"text" : "An argument"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 78.0, 110.0, 20.0 ],
					"text" : "With no argument"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 248.0, 171.0, 20.0 ],
					"text" : "specifies the number of outlets"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 153.5, 270.0, 121.0, 20.0 ],
					"text" : "The         inlet:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.75, 270.0, 26.0, 20.0 ],
					"text" : "left"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 211.0, 383.5, 130.0, 22.0 ],
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.625, 285.0, 147.0, 29.0 ],
					"text" : "0 = all closed;\nOutlet ID = which outlet is open"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.625, 321.0, 54.0, 31.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 321.0, 304.0, 18.0 ],
					"text" : "A handy way to get bangs randomly spaced between 20 - 1000 ms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 336.25, 352.0, 82.0, 22.0 ],
					"text" : "ranIJ 20 1000"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 322.25, 425.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 266.625, 425.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 211.0, 321.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 211.0, 425.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 322.25, 321.0, 96.0, 22.0 ],
					"text" : "metro @active 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 467.0, 258.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 25.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 12.5, 457.0, 987.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.25, 181.0, 130.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 153.5, 108.0, 121.0, 33.0 ],
					"text" : "The         inlet opens or closes the gate."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 263.625, 508.0, 54.0, 31.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 647.0, 506.0, 29.0 ],
					"text" : "The gist is: there are three different waveform qualities; on each bang, a short duration of the gated waveform is sent into a delay for a rhythmic echo-like quality."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 678.0, 505.0, 29.0 ],
					"text" : "You don't need to understand this engine, I'm just giving you an idea why you'd use gate.  You'll invent your own engine when you find sounds you like.  And gate may be useful to address it."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 316.566681000000017, 149.5, 81.0, 22.0 ],
									"text" : "tapout~ 1100"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 316.566681000000017, 178.5, 42.0, 22.0 ],
									"text" : "*~ 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 200.066651000000007, 149.5, 74.0, 22.0 ],
									"text" : "tapout~ 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 200.066651000000007, 178.5, 42.0, 22.0 ],
									"text" : "*~ 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 78.0, 149.5, 72.0, 22.0 ],
									"text" : "tapout~ 111"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 78.0, 182.5, 42.0, 22.0 ],
									"text" : "*~ 0.3"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 78.0, 109.5, 74.0, 22.0 ],
									"text" : "tapin~ 5000"
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-183", 0 ],
									"midpoints" : [ 209.566651000000007, 214.5, 280.316650999999979, 214.5, 280.316650999999979, 98.5, 87.5, 98.5 ],
									"source" : [ "obj-178", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"color" : [ 0.964289, 0.0, 0.999097, 1.0 ],
									"destination" : [ "obj-183", 0 ],
									"midpoints" : [ 87.5, 212.5, 160.749999999999972, 212.5, 160.749999999999972, 104.5, 87.5, 104.5 ],
									"order" : 0,
									"source" : [ "obj-182", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 87.5, 140.5, 209.566651000000007, 140.5 ],
									"order" : 1,
									"source" : [ "obj-183", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 87.5, 140.5, 326.066681000000017, 140.5 ],
									"order" : 0,
									"source" : [ "obj-183", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"color" : [ 0.964289, 0.0, 0.999097, 1.0 ],
									"destination" : [ "obj-183", 0 ],
									"midpoints" : [ 326.066681000000017, 212.5, 404.066681000000017, 212.5, 404.066681000000017, 93.5, 87.5, 93.5 ],
									"source" : [ "obj-292", 0 ]
								}
...
,
					"patching_rect" : [ 209.5, 696.0, 47.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 78.25, 729.0, 120.0, 55.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 336.25, 539.0, 82.0, 22.0 ],
					"text" : "ranIJ 20 1000"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 20.75, 229.5, 40.0, 22.0 ],
									"text" : "rect~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 205.625, 18.5, 62.0, 20.0 ],
									"text" : "loadmess 3"
								}
...
,
					"patching_rect" : [ 322.25, 653.0, 43.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 266.625, 653.0, 43.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 468.0, 729.0, 201.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.25, 729.0, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 326.25, 729.0, 72.0, 22.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 209.5, 762.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 209.5, 729.0, 105.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 211.0, 653.0, 44.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 97.5, 508.0, 107.0, 18.0 ],
					"text" : "Open an outlet of gate"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 322.25, 610.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 266.625, 610.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 211.0, 508.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 211.0, 610.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 322.25, 508.0, 96.0, 22.0 ],
					"text" : "metro @active 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 211.0, 578.0, 130.25, 22.0 ],
					"text" : "gate 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.75, 108.0, 26.0, 20.0 ],
					"text" : "left"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 346.5, 107.0, 35.0, 20.0 ],
					"text" : "right"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 211.0, 214.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 237.75, 147.0, 22.25, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 147.0, 22.25, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 10.5, 806.0, 987.0, 10.0 ],
					"pic" : "separation_line1.png"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.75, 78.0, 139.0, 20.0 ],
					"text" : "gate only has one outlet."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 322.25, 147.0, 119.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 52.0, 548.0, 20.0 ],
					"text" : "Pass an incoming message to one of many outlets (or prevent the message from passing altogether)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 3.0, 2.0, 46.0, 27.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.5, 647.0, 183.0, 78.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 322.25, 108.0, 150.0, 33.0 ],
					"text" : "The           inlet receives the message to pass"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 76.0, 508.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 446.0, 729.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 446.0, 647.0, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 345.75, 380.0, 425.0, 380.0, 425.0, 312.0, 408.75, 312.0 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 345.75, 567.0, 425.0, 567.0, 425.0, 499.0, 408.75, 499.0 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "ranIJ.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-MMJ-Depot-master/patchers/data_generation",
				"patcherrelativepath" : "../../../../../Max 8/Packages/CNMAT-MMJ-Depot-master/patchers/data_generation",
				"type" : "JSON",
				"implicit" : 1
			}
 ],
