...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 485.0, 14.5, 184.0, 22.0 ],
					"text" : "...(or a musical conductor)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 70.931640625, 110.796875, 177.916015625, 13.40625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
					"text" : "Wintergatan - Marble Machine",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 300.931640625, 104.0, 204.0, 19.0 ],
					"text" : "https://www.youtube.com/watch?v=IvUU8joBb1Q"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 545.0, 108.0, 106.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 73.0, 942.0, 33.0 ],
					"text" : "Watch the \"Marble Machine\" at the folllowing link.  Think of the marbles as data flowing in your patch.  And these objects in Max are like the mechanisms that send the marbles this way of that way, to activate different parts of your engine."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 142.0, 786.0, 33.0 ],
					"text" : "Alternatively: they act like a musical conductor: a conductor passes information (cues, information about volume) to specific parts of the orchestra, to make those specific instruments play in a specific way (louder, softer, more agitated, stop playing entirely)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 266.0, 812.0, 20.0 ],
					"text" : "Thus, this is just an intro.  Take a peek at these, remember that in general they are available to you, and you'll come back to them when you need them."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 221.0, 945.0, 33.0 ],
					"text" : "Its not that useful to learn these objects in a vaccuum, i.e. without first knowing a little more about MSP - you need to first know how to build and set up your ensemble / engine before investing in how to address certain parts of it.  "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 40.0, 45.0, 674.0, 20.0 ],
					"text" : "These objects (select, route, switch, selector~, gate, gate~, etc) allow you to send specific data to specific parts of your patch."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 19.0, 299.0, 987.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 12.0, 469.0, 27.0 ],
					"text" : "pass data this way or that - like a markble machine"
				}
