...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 533.875, 546.75, 297.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 164.0, 412.0, 39.0, 22.0 ],
					"text" : "t l b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.296630749999849, 207.0, 202.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.296630749999849, 238.0, 44.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 183.1982421875, 150.15234375, 165.7060546875, 12.2890625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 533.875, 300.75, 35.0, 45.00919540229885 ],
					"pic" : "design1.png"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 164.0, 362.25, 287.0, 21.0 ],
					"text" : "o.pack /fundamental 220 /harmonicity 1. /amp_curve 1.5"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 561.625, 567.75, 473.0, 19.0 ],
					"text" : "(Re-patch the poly~ from scratch.  It's simple!  Start a new patch and call it e.g. \"mySinusoids\")"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 533.875, 450.5, 229.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1062.421630750000077, 650.0, 132.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1062.421630750000077, 666.0, 138.0, 18.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 71.0, 255.0, 367.0, 170.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 575.296630749999963, 298.75, 494.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 575.296630749999963, 319.75, 340.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 533.875, 525.75, 259.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "adding up cycle~s with poly~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 32.0, 660.0, 20.0 ],
					"text" : "Here, each poly~ instance represents a partial, collectively producing a timbre.  By having [ poly~ 13 ], we have 13 partials."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.296630749999849, 142.296875, 151.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 805.296630749999849, 173.296875, 44.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 183.1982421875, 126.296875, 113.74072265625, 12.2890625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 66.0, 98.0, 398.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 74.0, 843.0, 20.0 ],
					"text" : "In the main patch, we make lists of all freqs and all amps.  Each poly~ instance looks up into these lists using its thispoly~ ID, getting its unique freq and amp."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 36.0, 52.0, 489.0, 20.0 ],
					"text" : "The poly~ abstraction contains two MSP objects: cycle~ (partial freq), and *~ (partial amp)."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 164.0, 525.75, 130.0, 35.0 ],
					"text" : "poly~ manySines 13 @target 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1062.421630750000077, 683.0, 53.0, 18.0 ],
					"text" : "Jon Kulpa"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 511.875, 525.75, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 511.875, 450.5, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 511.875, 300.25, 20.0, 20.0 ],
					"rounded" : 60.0,
					"text" : "1",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
