...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 576.0, 147.0, 20.0 ],
					"text" : "load if-statements_msp.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 421.65625, 576.0, 34.00390625, 13.40625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
					"text" : "MSP",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 554.0, 148.0, 20.0 ],
					"text" : "load if-statements_odot.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 421.65625, 554.0, 33.986328125, 13.40625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
					"text" : "odot",
					"textcolor" : [ 0.156862745098039, 0.407843137254902, 0.772549019607843, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 455.0, 534.0, 147.0, 20.0 ],
					"text" : "load if-statements_max.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 655.5, 594.0, 44.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 421.65625, 534.0, 31.34375, 13.40625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
					"text" : "Max",
					"textcolor" : [ 0.156862745098039, 0.407843137254902, 0.772549019607843, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 324.0, 175.0, 20.0 ],
					"text" : "Elements supporting (1) above:",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.0, 115.0, 36.0, 20.0 ],
					"text" : "what",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 115.0, 39.0, 20.0 ],
					"text" : "when",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 408.0, 115.0, 19.333333283662796, 19.0 ],
					"proportion" : 0.5,
					"rounded" : 400
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 71.0, 114.0, 19.333333283662796, 19.0 ],
					"proportion" : 0.5,
					"rounded" : 400
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.5, 533.0, 205.0, 20.0 ],
					"text" : "load audio-rate-to-control-rate_basic.maxpat"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 157.5, 564.0, 44.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 146.5, 471.59375, 74.57421875, 13.40625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
					"text" : "MSP -> Max",
					"textcolor" : [ 0.156862745098039, 0.407843137254902, 0.772549019607843, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 693.0, 397.0, 200.0, 87.0 ],
					"text" : "We may want the bang or click to produce an index, for example a preset # that looks up a preset's data.  [ counter ] or [ random ], for example, might respond to a bang to produce an index."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 397.0, 226.0, 74.0 ],
					"text" : "There is a class of objects that converts audio rate data into control rate data (for ex. turn a click into a bang).  There are only 2 of these ojects you need to know. Begin this unit by learning them here:"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 375.0, 76.0, 20.0 ],
					"text" : "MSP to Max",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 159.0, 228.0, 87.0 ],
					"text" : "However, we can study some powerful possibilities, as in changing presets (saved collections of data), or changing where data is sent in your patch, in turn activating an engine.  (using objects like gate, gate~, switch, selector~, etc.)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 435.0, 137.0, 111.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 397.0, 235.0, 74.0 ],
					"text" : "Some objects already provide a bang or click at the start or end of a process.  However, you naturally will have your own ideas that need some coding know-how (e.g. \"bang when 77% through\")."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 256.0, 214.0, 33.0 ],
					"text" : "e.g. \"the sample is done\" or \"counter is at its maximum\".  "
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 180.0, 216.0, 74.0 ],
					"text" : "This unit focuses on a specific class of bangs and clicks: those that mark when certain processes are starting, ending, or reaching some desired threshold."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 403.0, 481.0, 232.0, 47.0 ],
					"text" : "To express your own ideas about when a change occurs, you likely need the ability to express \"if-then\"."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 390.0, 375.0, 83.0, 20.0 ],
					"text" : "if-statements",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 112.0, 137.0, 214.0, 33.0 ],
					"text" : "These are bangs or clicks, triggering the change."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 680.0, 375.0, 133.0, 20.0 ],
					"text" : "index/section number",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 54.0, 274.0, 20.0 ],
					"text" : "Begin growing your abilities to code the following: ",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 115.0, 151.0, 20.0 ],
					"text" : "           the change occurs",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 431.0, 115.0, 155.0, 20.0 ],
					"text" : "          happens on change",
					"textcolor" : [ 0.066666666666667, 0.070588235294118, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 25.0, 30.0, 494.0, 20.0 ],
					"text" : "We can break down the change mechanism into certain tasks, or coding skills and patterns."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.0, 608.5, 49.0, 17.0 ],
					"text" : "Jon Kulpa"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 628.5, 883.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 2.5, 313.0, 27.0 ],
					"text" : "elements of a \"change mechanism\""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 71.5, 115.0, 18.5, 17.333333373069763 ],
					"rounded" : 60.0,
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 408.5, 116.0, 18.5, 17.333333373069763 ],
					"rounded" : 60.0,
					"text" : "2",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 372.0, 375.0, 16.0, 17.0 ],
					"rounded" : 60.0,
					"text" : "4",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 71.0, 375.0, 16.0, 17.0 ],
					"rounded" : 60.0,
					"text" : "3",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 662.0, 375.0, 16.0, 17.0 ],
					"rounded" : 60.0,
					"text" : "5",
					"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
				}
