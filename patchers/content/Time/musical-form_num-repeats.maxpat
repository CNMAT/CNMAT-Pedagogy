...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.75, 30.5, 349.0, 20.0 ],
					"text" : "We just saw chained objects produce a way to count repetitions."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.75, 77.0, 863.0, 33.0 ],
					"text" : "This might take some extra work to plan what you want (the carry count does not repeat but it can be reset - or you can use modulo, i.e. %).  Chaining and using the carry count are both good designs...use your preference."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 578.0, 503.0, 62.0, 58.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 567.333333343267441, 494.546877652406693, 9.666666477918625, 5.333333343267441 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 529.0, 441.296875, 36.0, 18.0 ],
					"text" : "if is 6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 567.0, 405.546875, 9.666666477918625, 5.333333343267441 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 567.0, 405.796875, 5.0, 89.749999791383743 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 578.0, 466.796875, 36.0, 22.0 ],
					"text" : ">~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 578.0, 410.296875, 40.0, 22.0 ],
					"text" : "==~ 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 578.0, 441.296875, 55.0, 22.0 ],
					"text" : "change~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 620.272705078125, 148.35546875, 87.45458984375, 12.2890625 ],
					"spacing_x" : 0.0,
					"spacing_y" : 0.0,
					"text" : "phase-tronome",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 145.5, 279.0, 43.0 ],
					"text" : "Same as to the left, only we start with a \nand count the clicks. To reset click.counter~ (count and carry count), send a click into its middle inlet."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.5, 145.5, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.5, 182.5, 44.0, 20.0 ],
					"text" : "pcontrol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 647.0, 322.5, 38.0, 31.0 ],
					"text" : "carry count"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 329.5, 38.0, 31.0 ],
					"text" : "carry count"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 501.0, 204.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 501.0, 241.796875, 39.0, 22.0 ],
					"text" : "click~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 501.5, 591.0, 31.0, 22.0 ],
					"text" : "stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 424.0, 591.0, 72.0, 22.0 ],
					"text" : "startwindow"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 424.0, 631.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 595.0, 325.5, 50.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 578.0, 241.796875, 46.0, 19.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 424.0, 325.5, 50.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 578.0, 266.796875, 29.5, 22.0 ],
					"text" : "10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 343.5, 204.5, 71.0, 20.0 ],
					"text" : "loadmess 200"
				}
...
,
					"patching_rect" : [ 424.0, 241.796875, 65.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 424.0, 204.5, 56.0, 22.0 ],
					"sig" : 200.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 424.0, 293.5, 173.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 206.249999999999943, 145.5, 27.0, 19.0 ],
					"text" : "and"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 150.25, 211.0, 26.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.75, 399.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 178.75, 366.5, 34.0, 22.0 ],
					"text" : "sel 6"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.499999999999943, 145.5, 218.000000000000114, 31.0 ],
					"text" : "To reset the count immediately        reset the carry count, set both of its reset inlets."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 178.75, 332.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 64.75, 332.5, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 64.75, 243.5, 66.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 64.75, 293.5, 133.0, 22.0 ],
					"text" : "counter 9"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.75, 54.0, 634.0, 20.0 ],
					"text" : "Counters also have their own built-in report: in addition to the carry flag (\"I'm done\"), there is a carry count (num reps)."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 837.0, 643.5, 53.0, 18.0 ],
					"text" : "Jon Kulpa"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 13.0, 663.5, 877.0, 10.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.0, 1.5, 288.0, 27.0 ],
					"text" : "do something upon num repeats"
				}
