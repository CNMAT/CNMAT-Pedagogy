...
,
					"patching_rect" : [ 144.0, 356.0, 72.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 720.0, 260.0, 16.0, 117.0 ],
					"presentation" : 1,
					"presentation_linecount" : 11,
					"presentation_rect" : [ 616.0, 184.0, 16.0, 117.0 ],
					"text" : "----- y a x i s -----"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 195.0, 56.0, 22.0 ],
					"text" : "onecopy"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 525.0, 504.0, 296.0, 60.0 ],
					"presentation" : 1,
					"presentation_linecount" : 6,
					"presentation_rect" : [ 144.0, 392.0, 185.0, 87.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 446.0, 385.0, 280.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 342.0, 309.0, 280.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 109.0, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 25.0, 131.0, 50.0, 22.0 ],
					"text" : "replace"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 241.0, 386.0, 128.0, 60.0 ],
					"presentation" : 1,
					"presentation_linecount" : 4,
					"presentation_rect" : [ 132.0, 300.0, 128.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 240.0, 168.0, 60.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 187.0, 178.0, 46.0, 22.0 ],
					"text" : "sig~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 240.0, 190.0, 57.0, 22.0 ],
					"text" : "loop 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 187.0, 216.0, 81.0, 22.0 ],
					"text" : "groove~ third"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 301.0, 122.0, 260.0, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 165.0, 135.0, 130.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 85.0, 131.0, 130.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 60.0, 512.0, 47.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 81.0, 60.0, 512.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 7.0, 623.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 24.0, 7.0, 623.0, 47.0 ],
