...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 836.375, 303.0, 26.0, 41.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 826.5, 346.0, 16.0, 19.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 714.5, 553.0, 47.0, 22.0 ],
					"text" : "zl nth 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 608.5, 620.0, 176.0, 20.0 ],
					"text" : "s CNMAT-Pedagogy_closed_system3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 654.041666666666515, 84.0, 50.0, 18.0 ],
					"text" : "args gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "" ],
					"patching_rect" : [ 598.0, 111.0, 29.5, 22.0 ],
					"text" : "t 0 l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 598.0, 84.0, 52.0, 22.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 845.375, 13.0, 62.0, 18.0 ],
					"text" : "Instantiation"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 860.875, 104.0, 104.0, 18.0 ],
					"text" : "4) my arg gate closes"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 860.875, 84.0, 164.0, 18.0 ],
					"text" : "3) my args gate receives message."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 860.875, 53.0, 157.0, 29.0 ],
					"text" : "2) on my loadbang, tell main patch's zl.reg to send args to me"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 860.875, 33.0, 116.0, 18.0 ],
					"text" : "1) main patch opens me"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 391.541666666666515, 55.0, 181.0, 20.0 ],
					"text" : "s CNMAT-Pedagogy_system3_opened"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 391.541666666666515, 22.0, 50.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 631.0, 55.0, 165.0, 20.0 ],
					"text" : "r CNMAT-Pedagogy_system3_args"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 913.375, 303.0, 94.0, 29.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 827.375, 560.0, 165.0, 62.0 ],
					"text" : "when the user closes this patch, this mechanism tells the _system2 to delete my name from the odot list that maintains which patches are open."
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 460.0, 308.0, 118.0, 97.0 ],
									"text" : "arg1 = \n  package_name\n       e.g. CNMAT-Pedagogy\narg2 = \n   1st-order folder_name \n       e.g. MSP\narg3 = \n   2nd-order folder_name\n       e.g. Delays"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "FullPacket", "FullPacket" ],
									"patching_rect" : [ 361.0, 208.0, 299.0, 59.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.458333333333371, 202.0, 65.0, 20.0 ],
					"text" : "showontab 0"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.5, 211.0, 137.5, 22.0 ],
									"text" : "sprintf /%s/%s"
								}
...
,
									"patching_rect" : [ 193.0, 97.0, 112.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 160.0, 73.0, 22.0 ],
													"text" : "fromsymbol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 50.0, 187.0, 49.0, 22.0 ],
													"text" : "zl.nth 2"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 50.0, 220.0, 111.0, 22.0 ],
													"text" : "characterRemove -"
												}
...
,
									"patching_rect" : [ 74.5, 97.0, 108.0, 22.0 ],
									"saved_object_attributes" : 									{
										"description" : "",
										"digest" : "",
										"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.5, 343.0, 77.0, 22.0 ],
									"text" : "prepend title"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 74.5, 56.0, 137.5, 22.0 ],
									"text" : "t l l"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 74.5, 8.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 74.5, 390.0, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 754.416666666666629, 202.0, 46.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "bang", "bang", "", "", "" ],
					"patching_rect" : [ 608.5, 170.0, 310.833333333333371, 22.0 ],
					"text" : "t b b l l l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 615.5, 227.0, 84.0, 51.0 ],
					"text" : "\"front\" causes this  abstraction to open from the system_patch_2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 608.5, 202.0, 31.0, 20.0 ],
					"text" : "front"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 608.5, 584.0, 125.0, 22.0 ],
					"text" : "zl reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 608.5, 553.0, 56.0, 20.0 ],
					"text" : "closebang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 608.5, 377.0, 347.0, 22.0 ],
					"text" : "Hi, I'm a _system3.maxpat (root patcher/tab)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 608.5, 342.0, 69.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 909.833333333333371, 545.0, 724.0, 545.0 ],
					"source" : [ "obj-19", 4 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-22", 0 ],
					"midpoints" : [ 607.5, 143.0, 591.5, 143.0, 591.5, 77.0, 607.5, 77.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"name" : "instantiate_system4s.maxpat",
				"bootpath" : "~/Documents/Max 8/Packages/CNMAT-Pedagogy/patchers/system/system_abstraction_dependencies",
				"patcherrelativepath" : "./system_abstraction_dependencies",
				"type" : "JSON",
				"implicit" : 1
